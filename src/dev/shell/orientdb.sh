...
docker run -d -p 2424:2424 -p 2480:2480 -e ORIENTDB_ROOT_PASSWORD=$ORIENTDB_ROOT_PASS -e ORIENTDB_OPTS_MEMORY="-Xms512M -Xmx8G -Dnetwork.binary.maxLength=56384" --name $ORIENTDB_CONTAINER_NAME orientdb:3.2.51
