...
import { INHERITED_NODE_BANNER_COLOR, DEFAULT_NODE_BANNER_COLOR, RELATED_NODE_BANNER_COLOR, DEFAULT_NODE_FILL, INHERITED_NODE_FILL, TREE_SCALE_FACTOR_X, TREE_SCALE_FACTOR_Y, HierarchyTypePageComponent } from "../hierarchy-type-page.component";
...
export class SvgHierarchyType {
    ...
    public static gotRectW: number = 120;
    public static gotRectH: number = 36;
    public static gotBodyFontSize: number = 8;
    public static gotOptionsButtonFontSize: number = 12;

    public static gotHeaderW: number = 120;
    public static gotHeaderH: number = 18;
    ...
    hierarchyComponent: HierarchyTypePageComponent;
    ...
    public constructor(hierarchyComponent: HierarchyTypePageComponent, svgEl: any, ht: HierarchyType, isPrimary: boolean, public localizationService: LocalizationService, public modalService: BsModalService, public authService: AuthService) {
