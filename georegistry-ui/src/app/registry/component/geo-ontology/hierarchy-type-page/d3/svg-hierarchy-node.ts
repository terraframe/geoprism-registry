...
import { HierarchyTypePageComponent, RELATED_NODE_BANNER_COLOR } from "../hierarchy-type-page.component";

export class SvgHierarchyNode {

    private hierarchyComponent: HierarchyTypePageComponent;
    ...
    */
    ...
    constructor(hierarchyComponent: HierarchyTypePageComponent, svgHierarchyType: SvgHierarchyType, geoObjectType: GeoObjectType, treeNode: any,
