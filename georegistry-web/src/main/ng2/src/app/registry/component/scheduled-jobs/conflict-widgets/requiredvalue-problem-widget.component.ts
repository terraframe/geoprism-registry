...
@Component( {
    selector: 'required-value-value-problem-widget',
    templateUrl: './requiredvalue-problem-widget.component.html',
    styleUrls: []
} )
export class RequiredValueProblemWidgetComponent implements OnInit {
    message: string = null;
