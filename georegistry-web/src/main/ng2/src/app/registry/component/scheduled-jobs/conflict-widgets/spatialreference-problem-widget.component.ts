...
@Component( {
    selector: 'spatial-reference-problem-widget',
    templateUrl: './spatialreference-problem-widget.component.html',
    styleUrls: []
} )
export class SpatialReferenceProblemWidgetComponent implements OnInit {
    message: string = null;
    @Input() conflict: any;
