...
@Component({
    ...
    selector: "programmatic-importer",
    templateUrl: "./programmatic-importer.component.html",
    styleUrls: ["./programmatic-importer.css"]
})
export class ProgrammaticImporterComponent implements OnInit {
    ...
    */
    programmaticTypes: ProgrammaticType[] = [];

    /*
     * Code of the currently selected GeoObjectType
     */
    programmaticTypeCode: string = null;
    ...
    */
    ...
    constructor(
        ...
        private programmaticService: ProgrammaticTypeService
    ) { }

    ngOnInit(): void {

        this.programmaticService.getAll().then(programmaticTypes => {
            this.programmaticTypes = programmaticTypes;
        });
        ...
        let getUrl = acp + "/excel/get-programmatic-config";
        ...
        this.uploader.onBuildItemForm = (fileItem: any, form: any) => {
            form.append("type", this.programmaticTypeCode);
