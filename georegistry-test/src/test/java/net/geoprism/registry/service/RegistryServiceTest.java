...
public class RegistryServiceTest
{
  ...
  @Test
  public void testNewGeoObjectInstance()
  {
    String json = testData.adapter.responseToString(testData.adapter.controller.newGeoObjectInstance(testData.adapter.clientRequest, testData.CO_D_ONE.getGeoObjectType().getCode()));
    
    System.out.println(json);
    
//    testNewGeoObjectInstanceInReq();
  }
//  @Request
//  private void testNewGeoObjectInstanceInReq()
//  {
//    System.out.println(AdapterUtilities.getInstance().getHierarchiesForType(testData.CO_D_ONE.getGeoObjectType().getGeoObjectType(GeometryType.MULTIPOLYGON), true).toString());
//  }
