...
public class AttributeValueGraphBuilder extends AbstractGraphBuilder
{
  public AttributeValueGraphBuilder(String path)
  {
    super(path);
  }
  ...
  protected void addAttribute(OVertex vertex, String name, String type, Object value)
  {
    for (int i = 0; i < this.years.length; i++)
    {
      ...
      vertex.addEdge(attributeValue, "ObjectHasValue").save();
    }
  ...
  {
    new AttributeValueGraphBuilder(args[0]).run();
  }
}
