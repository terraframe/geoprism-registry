...
import net.geoprism.registry.controller.UndirectedGraphController;
...
public class UndirectedGraphControllerWrapper extends TestControllerWrapper
{

  private UndirectedGraphController controller = new UndirectedGraphController();
  
  public UndirectedGraphControllerWrapper(TestRegistryAdapterClient adapter, ClientRequestIF clientRequest)
  {
