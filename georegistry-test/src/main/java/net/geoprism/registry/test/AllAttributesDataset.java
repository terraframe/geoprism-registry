...
/**
 * This dataset defines a parent Type and Geo-Object called ALL, and then
 * creates children Types and Geo-Objects for each of the different attribute
 * types. The ALL parent contians all custom attributes of all different data
 * types. Each child contains one of the custom attributes.
 * 
...
public class AllAttributesDataset extends TestDataSet
{
  ...
  {
    // GO_ALL.getGeoEntity().addLink(GeoEntity.getRoot(),
    // HIER.getServerObject().getEntityType());
