...
public class PublishListTypeJob extends PublishListTypeJobBase
{
  private static final long serialVersionUID = 500653024;

  public PublishListTypeJob()
  {
    super();
  }
  ...
  public JsonObject toJson()
  {
    ...
    final ListType masterlist = this.getListType();
    ...
    try
    {
      ...
      object.addProperty(PublishListTypeJob.OID, this.getOid());
      object.addProperty(PublishListTypeJob.LISTTYPE, this.getListTypeOid());
      object.addProperty(PublishListTypeJob.TYPE, type.getLabel().getValue());
