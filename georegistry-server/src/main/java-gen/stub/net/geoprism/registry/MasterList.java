...
public class MasterList extends MasterListBase
{
  ...
  public JsonObject toJSON(String versionType)
  {
    ...
    object.add(MasterList.DESCRIPTIONLOCAL, LocalizedValueConverter.convert(this.getDescriptionLocal()).toJSON(serializer));
    object.add(MasterList.PROCESSLOCAL, LocalizedValueConverter.convert(this.getProcessLocal()).toJSON(serializer));
    object.add(MasterList.PROGRESSLOCAL, LocalizedValueConverter.convert(this.getProgressLocal()).toJSON(serializer));
    object.add(MasterList.ACCESSCONSTRAINTSLOCAL, LocalizedValueConverter.convert(this.getAccessConstraintsLocal()).toJSON(serializer));
    object.add(MasterList.USECONSTRAINTSLOCAL, LocalizedValueConverter.convert(this.getUseConstraintsLocal()).toJSON(serializer));
    object.add(MasterList.ACKNOWLEDGEMENTSLOCAL, LocalizedValueConverter.convert(this.getUseConstraintsLocal()).toJSON(serializer));
    object.add(MasterList.DISCLAIMERLOCAL, LocalizedValueConverter.convert(this.getDisclaimerLocal()).toJSON(serializer));
