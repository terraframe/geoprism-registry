...
public class AddChildAction extends AddChildActionBase
{
  ...
  public boolean isVisible()
  {
    if (Session.getCurrentSession() != null && Session.getCurrentSession().getUser() != null)
    {
      try
      {
        ...
        return ServiceFactory.getGeoObjectRelationshipPermissionService().canAddChild(Session.getCurrentSession().getUser(), ht.getOrganization().getCode(), parent.getType().getCode(), child.getType().getCode());
      }
      catch (Exception e)
      {
  ...
  public void apply()
  {
    ...
    if (Session.getCurrentSession() != null && Session.getCurrentSession().getUser() != null)
    {
      ...
      ServiceFactory.getGeoObjectRelationshipPermissionService().enforceCanAddChildCR(actor, ht.getOrganization().getCode(), parent.getType().getCode(), child.getType().getCode());
    }
