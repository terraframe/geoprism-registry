...
public enum AllGovernanceStatus implements com.runwaysdk.business.BusinessEnumeration
{
  ...
  public static final java.lang.String CLASS = "net.geoprism.georegistry.action.AllGovernanceStatus";
  private net.geoprism.georegistry.action.GovernanceStatus enumeration;
  
  private synchronized void loadEnumeration()
  {
    net.geoprism.georegistry.action.GovernanceStatus enu = net.geoprism.georegistry.action.GovernanceStatus.getEnumeration(this.name());
    setEnumeration(enu);
  }
  
  private synchronized void setEnumeration(net.geoprism.georegistry.action.GovernanceStatus enumeration)
  {
