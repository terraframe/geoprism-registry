 ...
 */
public abstract class AddChildActionBase extends net.geoprism.georegistry.action.AbstractAction
{
  public final static String CLASS = "net.geoprism.georegistry.action.tree.AddChildAction";
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.georegistry.action.tree.AddChildAction.CLASS);
