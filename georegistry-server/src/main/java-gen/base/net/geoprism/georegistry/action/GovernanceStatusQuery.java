...

{
  ...
  {
    return net.geoprism.georegistry.action.GovernanceStatus.CLASS;
  }
  /**  
 ...
 **/
  ...
  public com.runwaysdk.query.Condition enum_AllGovernanceStatus()
  {
    ...
    com.runwaysdk.dataaccess.MdEnumerationDAOIF mdEnumerationIF = com.runwaysdk.dataaccess.metadata.MdEnumerationDAO.getMdEnumerationDAO(net.geoprism.georegistry.action.AllGovernanceStatus.CLASS); 
 ...
 **/
  public interface GovernanceStatusQueryReferenceIF extends com.runwaysdk.system.EnumerationMasterQuery.EnumerationMasterQueryReferenceIF
  {
    ...
    public com.runwaysdk.query.BasicCondition EQ(net.geoprism.georegistry.action.GovernanceStatus governanceStatus);

    public com.runwaysdk.query.BasicCondition NE(net.geoprism.georegistry.action.GovernanceStatus governanceStatus);
...
/**
 * Specifies type safe query methods for the enumeration net.geoprism.georegistry.action.AllGovernanceStatus.
 * This type is used when a join is performed on this class as an enumeration.
 **/
  public interface AllGovernanceStatusQueryIF extends GovernanceStatusQueryEnumerationIF  {

    public com.runwaysdk.query.Condition containsAny(net.geoprism.georegistry.action.AllGovernanceStatus ... allGovernanceStatus);
    public com.runwaysdk.query.Condition notContainsAny(net.geoprism.georegistry.action.AllGovernanceStatus ... allGovernanceStatus);
    public com.runwaysdk.query.Condition containsAll(net.geoprism.georegistry.action.AllGovernanceStatus ... allGovernanceStatus);
    public com.runwaysdk.query.Condition notContainsAll(net.geoprism.georegistry.action.AllGovernanceStatus ... allGovernanceStatus);
    public com.runwaysdk.query.Condition containsExactly(net.geoprism.georegistry.action.AllGovernanceStatus ... allGovernanceStatus);
  }

/**
 * Implements type safe query methods for the enumeration net.geoprism.georegistry.action.AllGovernanceStatus.
 * This type is used when a join is performed on this class as an enumeration.
 **/
 ...
 **/
  public interface GovernanceStatusQueryMultiReferenceIF extends com.runwaysdk.system.EnumerationMasterQuery.EnumerationMasterQueryMultiReferenceIF
  {
    ...
    public com.runwaysdk.query.Condition containsAny(net.geoprism.georegistry.action.GovernanceStatus ... governanceStatus);
    public com.runwaysdk.query.Condition notContainsAny(net.geoprism.georegistry.action.GovernanceStatus ... governanceStatus);
    public com.runwaysdk.query.Condition containsAll(net.geoprism.georegistry.action.GovernanceStatus ... governanceStatus);
    public com.runwaysdk.query.Condition notContainsAll(net.geoprism.georegistry.action.GovernanceStatus ... governanceStatus);
    public com.runwaysdk.query.Condition containsExactly(net.geoprism.georegistry.action.GovernanceStatus ... governanceStatus);
  }
