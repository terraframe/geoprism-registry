 ...
 */
public abstract class UpdateGeoObjectActionBase extends net.geoprism.georegistry.action.AbstractAction
{
  public final static String CLASS = "net.geoprism.georegistry.action.geoobject.UpdateGeoObjectAction";
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.georegistry.action.geoobject.UpdateGeoObjectAction.CLASS);
