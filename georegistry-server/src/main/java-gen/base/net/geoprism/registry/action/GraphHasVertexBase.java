 ...
 */
public abstract class GraphHasVertexBase extends com.runwaysdk.business.Relationship
{
  public final static String CLASS = "net.geoprism.registry.action.GraphHasVertex";
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.action.GraphHasVertex.CLASS);
  ...
  {
    return (GraphHasVertex) com.runwaysdk.business.Relationship.get(oid);
  }
  
  public static GraphHasVertex getByKey(String key)
  {
    return (GraphHasVertex) com.runwaysdk.business.Relationship.get(CLASS, key);
  }
  
  public static GraphHasVertex lock(java.lang.String oid)
  {
    GraphHasVertex _instance = GraphHasVertex.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static GraphHasVertex unlock(java.lang.String oid)
  {
    GraphHasVertex _instance = GraphHasVertex.get(oid);
    _instance.unlock();
