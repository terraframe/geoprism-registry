...
@com.runwaysdk.business.ClassSignature(hash = -411385609)
/**
 ...
 */
public abstract class ListTypeGroupBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -411385609;
  
  public ListTypeGroupBase()
  {
    super();
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.ListTypeGroup.CLASS);
  ...
  public net.geoprism.registry.ListTypeGroupLabel getLabel()
  {
    return (net.geoprism.registry.ListTypeGroupLabel) label;
  }
  ...
  public net.geoprism.registry.ListTypeGroup getParent()
  {
    ...
    {
      return net.geoprism.registry.ListTypeGroup.get(getValue(PARENT));
    }
  }
  ...
  public void setParent(net.geoprism.registry.ListTypeGroup value)
  {
    if(value == null)
    {
      setValue(PARENT, "");
  ...
  public static ListTypeGroupQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ListTypeGroupQuery query = new ListTypeGroupQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static ListTypeGroup get(String oid)
  {
    return (ListTypeGroup) com.runwaysdk.business.Business.get(oid);
  }
  
  public static ListTypeGroup getByKey(String key)
  {
    return (ListTypeGroup) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ListTypeGroup lock(java.lang.String oid)
  {
    ListTypeGroup _instance = ListTypeGroup.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static ListTypeGroup unlock(java.lang.String oid)
  {
    ListTypeGroup _instance = ListTypeGroup.get(oid);
    _instance.unlock();
