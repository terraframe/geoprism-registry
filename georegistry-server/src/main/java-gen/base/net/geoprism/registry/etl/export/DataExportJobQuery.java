 ...
 */
public  class DataExportJobQuery extends com.runwaysdk.system.scheduler.ExecutableJobQuery

{

  public DataExportJobQuery(com.runwaysdk.query.QueryFactory componentQueryFactory)
  {
  ...
  public DataExportJobQuery(com.runwaysdk.query.ValueQuery valueQuery)
  {
    super(valueQuery);
    if (this.getComponentQuery() == null)
    {
   ...
   * on this query object.
   */
  public com.runwaysdk.query.OIterator<? extends DataExportJob> getIterator()
  {
    ...
    return new com.runwaysdk.business.BusinessIterator<DataExportJob>(this.getComponentQuery().getMdEntityIF(), columnInfoMap, results);
  }
 ...
 **/
  public interface DataExportJobQueryReferenceIF extends com.runwaysdk.system.scheduler.ExecutableJobQuery.ExecutableJobQueryReferenceIF
  {
    ...
    public com.runwaysdk.query.BasicCondition NE(net.geoprism.registry.etl.export.DataExportJob dataExportJob);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class DataExportJobQueryReference extends com.runwaysdk.system.scheduler.ExecutableJobQuery.ExecutableJobQueryReference
 implements DataExportJobQueryReferenceIF

  {

  public DataExportJobQueryReference(com.runwaysdk.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.runwaysdk.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
    ...
    public com.runwaysdk.query.BasicCondition EQ(net.geoprism.registry.etl.export.DataExportJob dataExportJob)
    {
      if(dataExportJob == null) return this.EQ((java.lang.String)null);
      return this.EQ(dataExportJob.getOid());
    }

    public com.runwaysdk.query.BasicCondition NE(net.geoprism.registry.etl.export.DataExportJob dataExportJob)
    {
      if(dataExportJob == null) return this.NE((java.lang.String)null);
 ...
 **/
  public interface DataExportJobQueryMultiReferenceIF extends com.runwaysdk.system.scheduler.ExecutableJobQuery.ExecutableJobQueryMultiReferenceIF
  {
    ...
    public com.runwaysdk.query.Condition containsAll(net.geoprism.registry.etl.export.DataExportJob ... dataExportJob);
    public com.runwaysdk.query.Condition notContainsAll(net.geoprism.registry.etl.export.DataExportJob ... dataExportJob);
    public com.runwaysdk.query.Condition containsExactly(net.geoprism.registry.etl.export.DataExportJob ... dataExportJob);
  }
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class DataExportJobQueryMultiReference extends com.runwaysdk.system.scheduler.ExecutableJobQuery.ExecutableJobQueryMultiReference
 implements DataExportJobQueryMultiReferenceIF

  {

  public DataExportJobQueryMultiReference(com.runwaysdk.dataaccess.MdAttributeMultiReferenceDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, String mdMultiReferenceTableName, com.runwaysdk.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.runwaysdk.query.ComponentQuery rootQuery, java.util.Set<com.runwaysdk.query.Join> tableJoinSet, String alias, String displayLabel)
  {
    ...
    public com.runwaysdk.query.Condition containsAny(net.geoprism.registry.etl.export.DataExportJob ... dataExportJob)  {
      ...
      String[] itemIdArray = new String[dataExportJob.length]; 

      for (int i=0; i<dataExportJob.length; i++)
      {
        itemIdArray[i] = dataExportJob[i].getOid();
      }
