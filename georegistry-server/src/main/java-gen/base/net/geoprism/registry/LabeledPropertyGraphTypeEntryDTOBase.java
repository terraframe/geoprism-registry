...
public abstract class LabeledPropertyGraphTypeEntryDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  */
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(oid);
    
    return (net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO) dto;
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeEntryQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.registry.LabeledPropertyGraphTypeEntryQueryDTO) clientRequest.getAllInstances(net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
