...
{
  public final static String CLASS = "net.geoprism.registry.jobs.ImportError";
  ...
  public final static java.lang.String OBJECTJSON = "objectJson";
  ...
  {
    return getValue(OBJECTJSON);
  }
  
  public void validateObjectJson()
  {
    this.validateAttribute(OBJECTJSON);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeTextDAOIF getObjectJsonMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.jobs.ImportError.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeTextDAOIF)mdClassIF.definesAttribute(OBJECTJSON);
  }
  ...
  {
    this.validateAttribute(OBJECTTYPE);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeTextDAOIF getObjectTypeMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.jobs.ImportError.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeTextDAOIF)mdClassIF.definesAttribute(OBJECTTYPE);
  }
  ...
  public static ImportError get(String oid)
  {
    return (ImportError) com.runwaysdk.business.Business.get(oid);
  }
  
  public static ImportError getByKey(String key)
  {
    return (ImportError) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ImportError lock(java.lang.String oid)
  {
    ImportError _instance = ImportError.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static ImportError unlock(java.lang.String oid)
  {
    ImportError _instance = ImportError.get(oid);
    _instance.unlock();
