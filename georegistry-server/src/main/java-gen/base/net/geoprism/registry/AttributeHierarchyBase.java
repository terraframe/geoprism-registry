 ...
 */
public abstract class AttributeHierarchyBase extends com.runwaysdk.business.Business
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.AttributeHierarchy.CLASS);
  ...
  public static AttributeHierarchyQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    AttributeHierarchyQuery query = new AttributeHierarchyQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static AttributeHierarchy get(String oid)
  {
    return (AttributeHierarchy) com.runwaysdk.business.Business.get(oid);
  }
  
  public static AttributeHierarchy getByKey(String key)
  {
    return (AttributeHierarchy) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static AttributeHierarchy lock(java.lang.String oid)
  {
    AttributeHierarchy _instance = AttributeHierarchy.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static AttributeHierarchy unlock(java.lang.String oid)
  {
    AttributeHierarchy _instance = AttributeHierarchy.get(oid);
    _instance.unlock();
