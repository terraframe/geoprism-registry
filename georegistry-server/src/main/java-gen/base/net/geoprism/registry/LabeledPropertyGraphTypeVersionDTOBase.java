...
@com.runwaysdk.business.ClassSignature(hash = -2024452076)
public abstract class LabeledPropertyGraphTypeVersionDTOBase extends com.runwaysdk.business.BusinessDTO
{
  ...
  private static final long serialVersionUID = -2024452076;
  ...
  */
  ...
  public net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO getEntry()
  {
    ...
    {
      return net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO.get(getRequest(), getValue(ENTRY));
    }
  }
  ...
  public void setEntry(net.geoprism.registry.LabeledPropertyGraphTypeEntryDTO value)
  {
    if(value == null)
    {
      setValue(ENTRY, "");
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String oid)
  {
    ...
    return (net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO) dto;
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeVersionQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (net.geoprism.registry.LabeledPropertyGraphTypeVersionQueryDTO) clientRequest.getAllInstances(net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO.CLASS, "lock", _declaredTypes);
    return (net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String oid)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{oid};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO.CLASS, "unlock", _declaredTypes);
    return (net.geoprism.registry.LabeledPropertyGraphTypeVersionDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
