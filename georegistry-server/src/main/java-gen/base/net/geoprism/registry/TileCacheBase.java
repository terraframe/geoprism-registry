...
@com.runwaysdk.business.ClassSignature(hash = 1844039456)
/**
 ...
 */
public abstract class TileCacheBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = 1844039456;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.TileCache.CLASS);
  ...
  public static TileCacheQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    TileCacheQuery query = new TileCacheQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static TileCache get(String oid)
  {
    return (TileCache) com.runwaysdk.business.Business.get(oid);
  }
  
  public static TileCache getByKey(String key)
  {
    return (TileCache) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static TileCache lock(java.lang.String oid)
  {
    TileCache _instance = TileCache.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static TileCache unlock(java.lang.String oid)
  {
    TileCache _instance = TileCache.get(oid);
    _instance.unlock();
