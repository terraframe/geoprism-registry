...
@com.runwaysdk.business.ClassSignature(hash = -1709531797)
/**
 ...
 */
public abstract class ProgrammaticTypeBase extends com.runwaysdk.business.Business
{
  ...
  private static final long serialVersionUID = -1709531797;
  
  public ProgrammaticTypeBase()
  {
    super();
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.ProgrammaticType.CLASS);
  ...
  public net.geoprism.registry.ProgrammaticTypeDisplayLabel getDisplayLabel()
  {
    return (net.geoprism.registry.ProgrammaticTypeDisplayLabel) displayLabel;
  }
  ...
  public static ProgrammaticTypeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ProgrammaticTypeQuery query = new ProgrammaticTypeQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static ProgrammaticType get(String oid)
  {
    return (ProgrammaticType) com.runwaysdk.business.Business.get(oid);
  }
  
  public static ProgrammaticType getByKey(String key)
  {
    return (ProgrammaticType) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ProgrammaticType lock(java.lang.String oid)
  {
    ProgrammaticType _instance = ProgrammaticType.get(oid);
    _instance.lock();
    
    return _instance;
  }
  
  public static ProgrammaticType unlock(java.lang.String oid)
  {
    ProgrammaticType _instance = ProgrammaticType.get(oid);
    _instance.unlock();
