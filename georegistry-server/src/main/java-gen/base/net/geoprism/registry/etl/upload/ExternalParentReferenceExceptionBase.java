 ...
 * ExternalParentReferenceException.java
 *
...
public abstract class ExternalParentReferenceExceptionBase extends com.runwaysdk.business.SmartException
{
  ...
  {
    return getValue(AUTHORITY);
  }

  public void validateAuthority()
  {
    this.validateAttribute(AUTHORITY);
  }

  public static com.runwaysdk.dataaccess.MdAttributeTextDAOIF getAuthorityMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(net.geoprism.registry.etl.upload.ExternalParentReferenceException.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeTextDAOIF) mdClassIF.definesAttribute(AUTHORITY);
  }
  ...
  public java.lang.String localize(java.util.Locale locale)
  {
    ...
    message = replace(message, "{authority}", this.getAuthority());
