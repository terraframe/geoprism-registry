...
public abstract class GPRJobHistoryDTOBase extends com.runwaysdk.system.scheduler.JobHistoryDTO
{
  ...
  */
  ...
  public final com.runwaysdk.transport.metadata.AttributeJsonMdDTO getConfigJsonMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeJsonMdDTO) getAttributeDTO(CONFIGJSON).getAttributeMdDTO();
  }
