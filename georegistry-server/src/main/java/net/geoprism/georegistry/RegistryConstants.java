...
public interface RegistryConstants
{
  ...
  public static final String GEO_POINT_ATTRIBUTE_NAME             = "geoPoint";
  
  public static final String GEO_POINT_ATTRIBUTE_LABEL            = "Geo Point";
  
  public static final String GEO_LINE_ATTRIBUTE_NAME              = "geoLine";
  
  public static final String GEO_LINE_ATTRIBUTE_LABEL             = "Geo Line";
  
  public static final String GEO_POLYGON_ATTRIBUTE_NAME           = "geoPolygon";
  
  public static final String GEO_POLYGON_ATTRIBUTE_LABEL          = "Geo Polygon";
  
  public static final String GEO_MULTIPOINT_ATTRIBUTE_NAME        = "geoMultiPoint";
  
  public static final String GEO_MULTIPOINT_ATTRIBUTE_LABEL       = "Geo MultiPoint";
  
  public static final String GEO_MULTILINE_ATTRIBUTE_NAME         = "geoMultiLine";
  
  public static final String GEO_MULTILINE_ATTRIBUTE_LABEL        = "Geo MultiLine";
  
  public static final String GEO_MULTIPOLYGON_ATTRIBUTE_NAME      = "geoMultiPolygon";
