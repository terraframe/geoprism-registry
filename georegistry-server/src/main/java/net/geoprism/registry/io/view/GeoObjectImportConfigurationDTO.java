...
public class GeoObjectImportConfigurationDTO extends TypedObjectImportConfigurationDTO
{
  ...
  private List<ExternalIdMappingDTO> ids;
  ...
  public GeoObjectImportConfigurationDTO()
  {
    ...
    this.ids = new LinkedList<ExternalIdMappingDTO>();
  ...
  public void addIdMapping(ExternalIdMappingDTO dto)
  {
    this.ids.add(dto);
  }
  ...
  public List<ExternalIdMappingDTO> getIds()
  {
    return ids;
  }

  public void setIds(List<ExternalIdMappingDTO> ids)
  {
    this.ids = ids;
  }
}
