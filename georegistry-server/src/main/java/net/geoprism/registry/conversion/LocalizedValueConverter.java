...
public class LocalizedValueConverter
{
   ...
   * front-end, since that coalescing is actually use-case dependent. If you're looking for a method which does not
   * perform this auto-coalescing, then use localizedValue.setLocaleMap(localStruct.getLocaleMap()).
   */
