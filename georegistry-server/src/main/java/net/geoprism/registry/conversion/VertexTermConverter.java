...
{
  private AbstractClassification classification;

  public VertexTermConverter(AbstractClassification classification)
  {
  ...
  private Term buildTermFromClassifier(AbstractClassification classification)
  {
    ...
    Term term = new Term((String) classification.getCode(), label, new LocalizedValue(""));

    return term;
  }

//  @Transaction
//  public static AbstractClassification classification createClassifierFromTerm(String parentTermCode, Term term)
//  {
