...
public class GeoObjectCompositeCreateCommand
{
  ...
  public GeoObjectCompositeCreateCommand()
  {
    super();
  }

  public GeoObjectCompositeCreateCommand(String code, String type, List<GeoObjectEvent> events)
  {
    this.key = code + "#" + type;
    this.code = code;
    this.type = type;
