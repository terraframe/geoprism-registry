...
public class RemoveHiearchyEdgeEvent extends AbstractRepositoryEvent implements BusinessObjectEvent
{
  ...
  public RemoveHiearchyEdgeEvent()
  {
  }

  public RemoveHiearchyEdgeEvent(String targetCode, TypeInfo targetType, String sourceCode, TypeInfo sourceType, TypeInfo edgeType, Date startDate, Date endDate)
  {
