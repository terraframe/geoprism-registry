...
public class GeoSynonymService
{
  ...
  public JSONObject createGeoEntitySynonym(String sessionId, String typeCode, String code, String label)
  {
    return GeoVertexSynonym.createSynonym(typeCode, code, label);
  }

  @Request(RequestType.SESSION)
  public void deleteGeoEntitySynonym(String sessionId, String vOid)
  {
