...
@Service
public class UndirectedGraphTypeService extends EdgeClassService<UndirectedGraphType, GraphTypeDTO>
{
  @Autowired
  ...
  @Override
  protected EdgeClassBusinessServiceIF<UndirectedGraphType, GraphTypeDTO> getService()
  {
    return this.service;
  }
  ...
  {
    return this.etlBusinessService.getHistory(ObjectImporterFactory.JobHistoryType.EDGE_OBJECT.name(), code);
  }
