...
public class CurationBusinessService
{
  ...
  public JsonObject details(String historyId, boolean onlyUnresolved, int pageSize, int pageNumber)
  {
    ...
    jo.add("page", this.page(historyId, onlyUnresolved, pageSize, pageNumber));

    return jo;
  }

  
  public JsonObject page(String historyId, boolean onlyUnresolved, int pageSize, int pageNumber)
  {
    final ListCurationHistory hist = ListCurationHistory.get(historyId);
    final ListTypeVersion version = hist.getVersion();
    final ListType listType = version.getListType();
  ...
  @Transaction
  public void submitProblemResolution(String json)
  {
  ...
  @Transaction
  public void setResolution(String problemId, String resolution)
  {
