...
@Service
@Primary
public class GPRConceptClassBusinessService extends ConceptClassBusinessService implements ConceptClassBusinessServiceIF
{
  ...
  {
    ConceptClass type = super.apply(object);
