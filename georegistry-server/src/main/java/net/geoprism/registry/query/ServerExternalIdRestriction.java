...
public class ServerExternalIdRestriction implements ServerGeoObjectRestriction
{
  ...
  public ServerExternalIdRestriction(ServerGeoObjectType type, SourceAuthority authority, String externalId)
  {
    this.type = type;
  ...
  {
    return new VertexExternalIdRestriction(this.type, this.authority, this.externalId);
  }
}
