...
public class ProgrammaticObjectImportConfiguration extends ImportConfiguration
{
  ...
  private LinkedList<ProgrammaticObjectRecordedErrorException> errors           = new LinkedList<ProgrammaticObjectRecordedErrorException>();

  public ProgrammaticObjectImportConfiguration()
  {
  ...
  public void setType(ProgrammaticType type)
  {
    this.type = type;
  }
   ...
   * @return
   */
  public LinkedList<ProgrammaticObjectRecordedErrorException> getExceptions()
  {
    return this.errors;
  }

  public void addException(ProgrammaticObjectRecordedErrorException e)
  {
    this.errors.add(e);
  }
  ...
  public JSONObject toJSON()
  {
    ...
    config.put(ProgrammaticObjectImportConfiguration.TYPE, type);
    config.put(ProgrammaticObjectImportConfiguration.LOCATIONS, locations);

    if (this.getDate() != null)
    {
      config.put(ProgrammaticObjectImportConfiguration.DATE, format.format(this.getDate()));
    }

    if (this.hierarchy != null)
    {
      config.put(ProgrammaticObjectImportConfiguration.HIERARCHY, this.getHierarchy().getCode());
    }
  ...
  @Request
  public ProgrammaticObjectImportConfiguration fromJSON(String json, boolean includeCoordinates)
  {
    super.fromJSON(json);
    ...
    try
    {
      if (config.has(ProgrammaticObjectImportConfiguration.DATE))
      {
        this.setDate(format.parse(config.getString(ProgrammaticObjectImportConfiguration.DATE)));
      }
    }
  ...
  public static String getBaseType(String attributeType)
  {
    ...
    {
      return ProgrammaticObjectImportConfiguration.TEXT;
    }
    else if (attributeType.equals(AttributeFloatType.TYPE) || attributeType.equals(AttributeIntegerType.TYPE))
    {
      return ProgrammaticObjectImportConfiguration.NUMERIC;
    }
