...
public class BusinessObjectImporter extends ObjectImporter<BusinessObject, BusinessType, BusinessTypeDTO> implements ObjectImporterIF
{
  ...
  public BusinessObjectImporter(BusinessObjectImportConfiguration configuration, ImportProgressListenerIF progressListener)
  {
    ...
    this.service = ServiceFactory.getBean(BusinessObjectBusinessServiceIF.class);
  }

  @Override
  protected BusinessObjectBusinessServiceIF getService()
  {
    return this.service;
  }
