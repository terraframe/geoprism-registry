...
public class ExternalId
{
  ...
  {
    return this.getExternalId() + KEY_SEPARATOR + this.getParent().getCode() + KEY_SEPARATOR + this.getChild().getType().getCode();
  }
  ...
  public SourceAuthority getParent()
  {
    return (SourceAuthority) this.edge.getParent();
  }
  ...
  {
    final SourceAuthority authority = this.getParent();
    ...
    dto.setAuthorityLabel(authority.getLabel().getValue());
