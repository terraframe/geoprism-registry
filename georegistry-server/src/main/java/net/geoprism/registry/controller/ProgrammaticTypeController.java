...
import net.geoprism.registry.service.ProgrammaticTypeService;

@Controller(url = "programmatic-type")
public class ProgrammaticTypeController
{
  private ProgrammaticTypeService service;

  public ProgrammaticTypeController()
  {
    this.service = new ProgrammaticTypeService();
  }
