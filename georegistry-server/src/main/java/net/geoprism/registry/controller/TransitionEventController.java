...
public class TransitionEventController extends RunwaySpringController
{
  ...
  public ResponseEntity<String> page( //
      ...
      @RequestParam(name = "attrConditions", required = false) String attrConditions)
  {
  ...
  public ResponseEntity<String> getDetails(@NotEmpty @RequestParam(name = "oid") String oid)
  {
  ...
  public ResponseEntity<InputStreamResource> exportExcel( //
      @NotEmpty @RequestParam(name = "typeCode") String typeCode, //
      @RequestParam(name = "startDate", required = false) Date startDate, //
      @RequestParam(name = "endDate", required = false) Date endDate) throws IOException
  {
