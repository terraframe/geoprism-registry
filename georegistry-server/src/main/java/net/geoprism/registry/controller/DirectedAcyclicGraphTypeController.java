...
@Controller(url = "directed-graph-type")
public class DirectedAcyclicGraphTypeController
{
  private DirectedAcyclicGraphTypeService service;

  public DirectedAcyclicGraphTypeController()
  {
    this.service = new DirectedAcyclicGraphTypeService();
  }
